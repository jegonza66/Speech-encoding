...
for situation in config.situations:    
    ...
    for band in config.bands:
        for stim in config.stimuli:
            ...
            # Relevant paths
            path_figures = f'figures/leadership/{config.model}/{situation}/stims_{config.stims_preprocess}_EEG_{config.eeg_preprocess}/tmin{config.tmin}_tmax{config.tmax}/{band}/{stim}/'
