...
Mean_Correlations_fname = 'saves/25_folds/{}/{}/correlations/tmin{}_tmax{}/Mean_Correlations.pkl'.format(model, situacion, tmin, tmax)
try:
...
for Band in Bands:
    ...
    for stim in Stims:
        ...
        # Paths
        save_path = 'saves/25_folds/{}/{}/correlations/tmin{}_tmax{}/'.format(model, situacion, tmin, tmax)
