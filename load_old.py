...
# Modules
import utils.processing as processing, utils.general_functions as funciones, config
...
if __name__ == "__main__":
    for situation in config.situations:
        preprocessed_data_path_main = f'savesoldd/preprocessed_data/{situation}/tmin{config.tmin}_tmax{config.tmax}/'
